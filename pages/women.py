...
model_folder = "women_model_details"
...
dataset_csv = "archive/women.csv"  # Adjust accordingly
image_folder = "archive/women_images"  # Adjust accordingly
dataset = load_dataset(dataset_csv, image_folder)

st.title("Fashion Recommendation System For women")
...
#############################################################################################################################################################
#############################################################################################################################################################
    pkl_path = "women_model_details/dominant_colors.pkl"  # Adjust path as needed
